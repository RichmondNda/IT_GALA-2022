                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="ml-4">
                                                            <div class="flex gap-4" >
                                                                ...
                                                                <a href="https://wa.me/+225{{$personne->contact}}9?text=Bonjour, Bonsoir {{$personne->nom}} {{$personne->prenom}} j'espère que vous allez bien. Veuillez bien vérifier votre boîte mail, votre ticket vous été envoyé.                            Cordialement, le C2E"  class="text-sm font-bold  text-green-400 border-2 px-2 rounded-full  py-2 text-md">
