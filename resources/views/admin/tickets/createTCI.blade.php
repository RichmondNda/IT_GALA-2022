            ...
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                ...
                <div class="  py-6 px-6">
                        ...
                        <div class=" py-4  my-4 ">
                            ...
                            <form  style="" action="{{ route('admin.ticket.store.tci',null,false) }}" class="" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-2 pt-0 mb-3">
                                        <label class="font-bold "> Matricule Homme </label>
                                        <input type="text" placeholder="matricule de l'homme"   name='matricule_h' value="{{old("matricule_h")}}"
                                        class="relative w-full px-3 py-2 text-sm text-gray-600 placeholder-gray-400 bg-white border-gray-400 rounded outline-none focus:border-coolGray-400 focus:outline-none focus:ring-coolGray-100" />
                                        @error('matricule_h')
                                                <div class="text-sm font-thin text-center text-red-600">{{ $errors->first('matricule_h') }}  </div>
                                        @enderror
                                    </div>

                                    <div class="col-span-2 pt-0 mb-3">
                                        <label class="font-bold "> Matricule femme </label>
                                        <input type="text" placeholder="matricule de la femme"   name='matricule_f' value="{{old("matricule_f")}}"
                                        class="relative w-full px-3 py-2 text-sm text-gray-600 placeholder-gray-400 bg-white border-gray-400 rounded outline-none focus:border-coolGray-400 focus:outline-none focus:ring-coolGray-100" />
                                        @error('matricule_f')
                                                <div class="text-sm font-thin text-center text-red-600">{{ $errors->first('matricule_f') }}  </div>
                                        @enderror
                                    </div>
